...
#region Methods/Unity Methods
	...
	{
		//UXMLからツリー構造を読み取り
		var tree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Packages/com.colloid.pbreplacer/Editor/PBReplacer.uxml");
...
#region Methods/Other Methods
	...
	{
		//Debug.Log("ボタンが押されたよ");
		_avatarDynamicsPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Packages/com.colloid.pbreplacer/Editor/Resources/AvatarDynamics.prefab");
		if (_vrcavatar == null)
		{
			return;
		}
